...
def placeholder_fields():
    ...
    return jsonify([
        ...
        {'key': 'landlord_name',    'label': 'Landlord/Owner Name', 'example': 'Moshe Cohen'},
        {'key': 'total_collected',  'label': 'Total Collected',     'example': '5000'},
        {'key': 'amount_due',       'label': 'Amount Due',          'example': '1500'},
        {'key': 'job_type',         'label': 'Job/Work Type',       'example': 'Plumbing repair'},
        {'key': 'job_apartment',    'label': 'Job Apartment',       'example': 'Apt 134, Tower Chekalov'},
        {'key': 'job_date',         'label': 'Job Date',            'example': '2026-04-25'},
    ])
